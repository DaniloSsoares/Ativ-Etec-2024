            ...
            <form method="POST" action="/adicionarContato" enctype="multipart/form-data">
                ...
                <div class="md:flex items-center mt-12 mt-4">
                    ...
                    <div class="w-full md:w-1/2 flex flex-col mt-4">
                        ...
                        <input type="file" name="capa"  class="leading-none text-gray-900 p-2 focus:outline-none focus:border-blue-700 mt-3 bg-gray-200 border rounded border-gray-200"/>
                    </div>
