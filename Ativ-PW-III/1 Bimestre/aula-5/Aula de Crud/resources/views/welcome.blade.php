...
<div class="container mt-4">
  <div class="row row-cols-1 row-cols-md-3 g-4">
    ...
    <div class="col d-flex justify-content-center">
      <div class="card"  >
        <img src="img/listar.png" class="card-img-top" alt="...">
        <div class="card-body">
    ...
    <div class="col">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Área de realização de Edição.</p>
          <button class="btn btn-outline-warning" id="Editar" type="submit">Atualização</button>
        </div>
      </div>
    </div>
