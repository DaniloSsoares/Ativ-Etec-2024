...
(1, 1, 'A Casa é Sua', 'Casa Worship', 5.30),
(1, 2, 'Aquieta Minh’alma', 'Ministério Zoe', 6.40),
(2, 3, 'Jireh', 'Elevation Worship & Maverick City', 8.59),
(2, 4, 'Recomeçar', 'Juliano Son', 4.22),
(3, 5, 'Deus de Promessas', 'Davi Sacer', 5.15),
(3, 6, 'Algo Novo', 'Kemuel, Lukas Agustinho', 4.55),
(4, 7, 'Não Pare', 'Midian Lima', 5.10),
(4, 8, 'É Tudo Sobre Você', 'Ministério Morada', 6.05),
(5, 9, 'Todos os meus dias', 'Gabriel Guedes', 3.23),
(5, 10, 'Cordeiro e Leão', 'Isaque Valadão', 5.34),
(1, 11, 'Vitorioso És', 'Gabriel Guedes', 6.00),
